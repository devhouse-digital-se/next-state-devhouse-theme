	        ...
	        <div class="row">
	            ...
	            <div class="col home-hero__content">
	            	<?php if (get_field('hero_subheadline')) : ?>
        				<h3 class="hero__sub-headline"><?php echo get_field('hero_subheadline'); ?></h3>
        			<?php endif; ?>
        			...
        			<?php if (get_field('hero_cta_text') && get_field('hero_cta_link')) : ?>
        				<a href="<?php echo get_field('hero_cta_link'); ?>" class="d-block btn btn-primary"><?php echo get_field('hero_cta_text'); ?></a>
        			<?php endif; ?>
        		</div>
